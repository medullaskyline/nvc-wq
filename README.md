...
#### notes
added 'boolean': 'checkbox', to xlsvconf.html.HTML5_INPUT_TYPES
this creates a new feelingsneedsentry_edit.html
but still need to render the correct template in the javascript